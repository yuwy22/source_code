...
public class PairwiseAlignment {
  ...
  public static void main(String[] args) throws Exception {
	  ...
	  // I have included "trna.fasta" and "test.fasta" files as addition files,
       File myFile = new File("test.fasta"); //read the fasta file
      // File myFile = new File("test.fasta"); // If you want to test this fasta file, uncomment it. But remember commet the line above.
